...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ltde.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '昔尘科技, 昔尘, 昔尘源分享, 公益', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'pastking@ltde.cm', // 邮箱地址 例如mail@tangly1024.com
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['https://gitee.com/past-dust/code-repository/raw/master/PastKingGPT.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  ...
  TianliGPT_JS:
    ...
    'hhttps://gitee.com/past-dust/code-repository/raw/master/abc.js',
  TianliGPT_KEY: process.env.NEXT_PUBLIC_TIANLI_GPT_KEY || '5Q5mpqfK5DkwT1X9Gi5e',
